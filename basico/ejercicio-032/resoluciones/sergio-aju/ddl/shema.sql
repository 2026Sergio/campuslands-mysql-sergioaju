...
Aunque el ejercicio pertenece al nivel basico, debes resolverlo con mentalidad profesional: nombres claros, datos coherentes, consultas verificables y evidencia de resultados.

## Objetivo
Practicar tipos de datos en MySQL creando una solucion que pueda ejecutarse desde cero y que demuestre analisis, orden y criterio tecnico.
...
```text
basico/ejercicio-032/resoluciones/juan-perez/
├── README.md
├── ddl/schema.sql
├── dml/inserts.sql
└── dql/consultas.sql
